...
class Inventory extends Model
{
    ...
    {
        $this->table = env('INVENTORY_TABLE_V3', 'voertuigen_global');
    }
...
//                    $images[] = self::IMAGE_URL . $baseName . '-' . $i . '.' . $ext;
    ...
    public function getVideosAttribute()
    {
        ...
        $videos = [];
        if ($json !== null) {
            if (array_key_exists('videos', $json) && $json['videos']) {
